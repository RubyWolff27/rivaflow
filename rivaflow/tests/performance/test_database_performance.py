...
class TestDatabasePerformance:
    ...
    def test_pagination_performance(self, large_dataset):
        ...
        assert avg_page_time < 0.1, f"Pagination took {avg_page_time:.3f}s per page, should be under 0.1s"
...
class TestQueryOptimization:
    ...
    def test_avoid_n_plus_1_partners(self):
        ...
        try:
            ...
            assert query_time < 0.5, f"Partner extraction took {query_time:.3f}s, possible N+1 problem"
