...
export default function RestDetail() {
  ...
  if (loading) {
    return (
      <div className="max-w-3xl mx-auto text-center py-12">
        <p className="text-gray-600 dark:text-gray-400">Loading rest day...</p>
      </div>
    );
  }
  ...
  if (!restDay) {
    return (
      <div className="max-w-3xl mx-auto text-center py-12">
        <p className="text-gray-600 dark:text-gray-400">Rest day not found</p>
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white" id="page-title">Rest Day</h1>
        </div>
        <Link
