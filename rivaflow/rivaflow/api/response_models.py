...
class SessionResponse(BaseModel):
    ...
    garmin_avg_hr: int | None = None
    garmin_max_hr: int | None = None
    garmin_calories: int | None = None
    garmin_duration_min: float | None = None
    ...
    garmin_hr_z1_sec: float | None = None
    garmin_hr_z2_sec: float | None = None
