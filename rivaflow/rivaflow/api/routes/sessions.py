...
def update_session(
    ...
    updated = service.update_session(
        ...
        whoop_avg_hr=session.whoop_avg_hr,
        whoop_max_hr=session.whoop_max_hr,
        garmin_activity_type=session.garmin_activity_type,
        garmin_activity_name=session.garmin_activity_name,
        garmin_avg_hr=session.garmin_avg_hr,
        garmin_max_hr=session.garmin_max_hr,
        garmin_calories=session.garmin_calories,
        garmin_duration_min=session.garmin_duration_min,
        garmin_aerobic_te=session.garmin_aerobic_te,
        garmin_anaerobic_te=session.garmin_anaerobic_te,
        garmin_te_label=session.garmin_te_label,
        garmin_training_load=session.garmin_training_load,
        garmin_hr_z1_sec=session.garmin_hr_z1_sec,
        garmin_hr_z2_sec=session.garmin_hr_z2_sec,
        ...
        strava_activity_name=session.strava_activity_name,
        strava_activity_type=session.strava_activity_type,
        strava_avg_hr=session.strava_avg_hr,
        strava_max_hr=session.strava_max_hr,
        strava_calories=session.strava_calories,
        strava_duration_min=session.strava_duration_min,
        strava_suffer_score=session.strava_suffer_score,
        strava_distance_m=session.strava_distance_m,
        attacks_attempted=session.attacks_attempted,
        attacks_successful=session.attacks_successful,
        defenses_attempted=session.defenses_attempted,
        defenses_successful=session.defenses_successful,
...
def backfill_scores(
    ...
    scoring = SessionScoringService()
    result = scoring.backfill_user_scores(current_user["id"], force=force)
    return result
