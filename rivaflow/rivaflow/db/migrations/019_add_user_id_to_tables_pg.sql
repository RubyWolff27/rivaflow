...
ALTER TABLE sessions ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_sessions_user_id ON sessions(user_id);

-- Add user_id to readiness
ALTER TABLE readiness ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_readiness_user_id ON readiness(user_id);

-- Add user_id to contacts
ALTER TABLE contacts ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_contacts_user_id ON contacts(user_id);

-- Add user_id to gradings
ALTER TABLE gradings ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_gradings_user_id ON gradings(user_id);

-- Add user_id to daily_checkins
ALTER TABLE daily_checkins ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_daily_checkins_user_id ON daily_checkins(user_id);

-- Add user_id to streaks
ALTER TABLE streaks ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_streaks_user_id ON streaks(user_id);

-- Add user_id to milestones
ALTER TABLE milestones ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS idx_milestones_user_id ON milestones(user_id);

-- Add user_id to goal_progress
ALTER TABLE goal_progress ADD COLUMN user_id BIGINT NOT NULL DEFAULT 1 REFERENCES users(id) ON DELETE CASCADE;
...
CREATE TABLE IF NOT EXISTS profile_new (
    ...
    show_weekly_goals BOOLEAN DEFAULT TRUE,
...
-- Step 5: CREATE INDEX IF NOT EXISTS for user_id lookups
