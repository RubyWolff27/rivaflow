-- Migration 052: Add Activity-Specific Weekly Goals (PostgreSQL)
-- Created: 2026-02-03
...
ALTER TABLE profile ADD COLUMN IF NOT EXISTS weekly_bjj_sessions_target INTEGER DEFAULT 3;
ALTER TABLE profile ADD COLUMN IF NOT EXISTS weekly_sc_sessions_target INTEGER DEFAULT 1;
ALTER TABLE profile ADD COLUMN IF NOT EXISTS weekly_mobility_sessions_target INTEGER DEFAULT 0;
